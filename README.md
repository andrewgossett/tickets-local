...
- **macOS:** [Download the signed and Apple-notarized universal DMG](https://github.com/andrewgossett/tickets-local/releases/download/v0.5.11/Tickets-Local-0.5.11-macOS-universal-notarized.dmg)
- **Windows:** [Download the Windows x64 application](https://github.com/andrewgossett/tickets-local/releases/download/v0.5.11/Tickets-Local-0.5.11-Windows-x64.exe)
- **Windows ZIP:** [Download the portable Windows x64 ZIP](https://github.com/andrewgossett/tickets-local/releases/download/v0.5.11/Tickets-Local-0.5.11-Windows-x64-unsigned.zip)
...
- Responder records, capabilities, status, and incident assignment
...
1. [Download the Windows x64 application](https://github.com/andrewgossett/tickets-local/releases/download/v0.5.11/Tickets-Local-0.5.11-Windows-x64.exe), or download and unzip the [portable Windows ZIP](https://github.com/andrewgossett/tickets-local/releases/download/v0.5.11/Tickets-Local-0.5.11-Windows-x64-unsigned.zip).
...
1. [Download the signed and Apple-notarized universal DMG](https://github.com/andrewgossett/tickets-local/releases/download/v0.5.11/Tickets-Local-0.5.11-macOS-universal-notarized.dmg).
...
on the [release page](https://github.com/andrewgossett/tickets-local/releases/tag/v0.5.11).
...
`dist/Tickets-Local-0.5.11-Windows-x64-unsigned.zip` and its `.sha256` file.
