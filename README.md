...
1. [Download the signed and Apple-notarized universal DMG](https://github.com/andrewgossett/tickets-local/releases/download/v0.5.15/Tickets-Local-0.5.15-macOS-universal-notarized.dmg).
...
on the [release page](https://github.com/andrewgossett/tickets-local/releases/tag/v0.5.15).
...
`dist/Tickets-Local-0.5.15-Windows-x64-unsigned.zip` and its `.sha256` file.
