...
- **Windows:** [Download the Windows x64 application](https://github.com/andrewgossett/tickets-local/releases/download/v0.5.16/Tickets-Local-0.5.16-Windows-x64.exe)
- **Windows ZIP:** [Download the portable Windows x64 ZIP](https://github.com/andrewgossett/tickets-local/releases/download/v0.5.16/Tickets-Local-0.5.16-Windows-x64-unsigned.zip)
