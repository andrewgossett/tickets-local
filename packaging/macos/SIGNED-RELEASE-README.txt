TICKETS LOCAL 0.5.11 — MAC SIGNING AND NOTARIZATION KIT
======================================================
...
The finished files appear in the "Signed Release" folder:
  ...
  Tickets-Local-0.5.11-macOS-universal-notarized.dmg
  Tickets-Local-0.5.11-macOS-universal-notarized-SHA256.txt
  Tickets-Local-0.5.11-source.zip
...
matching Tickets-Local-0.5.11-source.zip and Third-Party-Source directory in the
